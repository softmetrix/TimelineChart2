var TimelineChart = (function() {
    ...
    function setConfig(_config) {
      Object.keys(_config).forEach(function(key,index) {
    ...
    function populateSwimlanes() {
      ...
      var t2 = performance.now(); // debug
      console.log('populateSwimlanes execution time: ' + (t2 - t1)); // debug
    }
    ...
    function createChart(data, _containerSelector, _classes, config = {}) {
